...
<body>
    ...
    <div class="container mt-3" id="container">
        ...
        <a href="action-logout.php" class="btn btn-warning d-inline">Log out</a>

        <form method="POST" class="my-3">
            <input id="keyword" type="text" class="form-control" name="searchInput" placeholder="Cari..." autocomplete="off">
        </form>
